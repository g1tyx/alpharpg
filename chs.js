...
var cnItems = {
    ...
    "NINJA": "忍者",
    "Ninjas are elite fighters, planning and plotting before the fight.": "忍者是精英战士，在战斗前计划和策划。",
    "Not Started": "没有开始",
    ...
    "SUPERIOR Evil Soul": "卓越邪恶灵魂",
    "SUPERIOR Kind Soul": "卓越的善良灵魂",
    "Your save has been imported.": "您的存档已导入。",
    "Save imported": "存档已导入",
    "NORMAL Evil Soul": "普通的邪恶灵魂",
    "ELITE Kind Soul": "精英善良的灵魂",
    "Lost Path - Lv.": "迷失之路 - 等级",
    "NORMAL African Wolf": "普通非洲狼",
    "Shadow Forest - Lv.": "暗影森林 - 等级",
    "SUPERIOR Wolf": "高级狼",

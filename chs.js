...
var cnItems = {
    ...
    "Adventurer": "冒险家",
    "Bank": "银行",
    "By passing through the dimensional rift you will lose your current equipment and missions progression.": "通过维度裂缝，您将失去当前的装备和任务进度。",
    "Completed story": "完成的故事",
    "Current dimension": "当前维度",
    "Currently set to": "目前设置为",
    "deli": "熟食店",
    "discord": "不和谐",
    "for their help during the early development!": "感谢他们在早期开发过程中的帮助！",
    "Guild": "公会",
    "Hide all": "全部藏起来",
    "Hide old versions players": "隐藏旧版本播放器",
    "Offline": "离线",
    "Only with loot": "只有战利品",
    "Purple_Wizard": "Purple_Wizard",
    "RPG v3.4 BETA": "RPG v3.4 测试版",
    "Score required": "需要分数",
    "Shop": "店铺",
    "Show all": "显示所有",
    "show all rewards": "显示所有奖励",
    "Skip rewards": "跳过奖励",
    "This part of the game will be available in a future update": "这部分游戏将在未来的更新中提供",
    "Titles": "标题",
    "Unlocks the Mind Control (idle mode": "解锁心灵控制（空闲模式",
    "Work in Progress": "工作正在进行中",
    "You can choose to skip all rewards or only when there is no item dropped": "您可以选择跳过所有奖励或仅在没有物品掉落时",
    ", Adventurer": ", 冒险者",
    "Unranked/": "未排名/",
    "hide all rewards": "隐藏所有奖励",
    "Invalid code ! (error": "无效的代码 ！ （错误",
    "show only rewards with loot": "仅显示战利品奖励",
    "Boots of Destiny": "命运之靴",
    "Shield of Legend": "传说之盾",
    "Available slots ": "可用插槽",
    "Boots of Destiny": "命运之靴",
    "Confirm": "确认",
    "Legendary Shield of Destiny": "传说中的命运之盾",
    "Legendary Unreal Boots": "传奇虚幻靴子",
    "Return to the game": "返回游戏",
    "Shield of Legend": "传奇之盾",
    "Throw away your current Boots ?": "扔掉你现在的靴子？",
    "Throw away your current Shield ?": "扔掉你现在的盾牌？",
    "": "",
    "": "",
    "": "",
    "": "",
